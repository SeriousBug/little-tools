...
it('displays formatted timestamp based on format selection', async () => {
  ...
  let formattedTimestamp = screen.getByText('Formatted Timestamp:').nextElementSibling;
  ...
  formattedTimestamp = screen.getByText('Formatted Timestamp:').nextElementSibling;
